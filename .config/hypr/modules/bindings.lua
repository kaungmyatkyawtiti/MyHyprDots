...
hl.bind("XF86AudioMicMute", hl.dsp.exec_cmd(volume .. " micmute"), { locked = true, repeating = true })

hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd(brightness .. " brightup"), { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd(brightness .. " brightdown"), { locked = true, repeating = true })

hl.bind("Caps_Lock", hl.dsp.exec_cmd(capslock), { release = true })
hl.bind("CAPS + Caps_Lock", hl.dsp.exec_cmd(capslock), { release = true })
