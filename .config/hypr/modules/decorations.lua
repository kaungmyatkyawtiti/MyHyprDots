...
hl.curve("closeSpring", { type = "spring", mass = 1.0, stiffness = 100, dampening = 15 })
...
hl.animation({ leaf = "windowsOut", enabled = true, speed = 2.5, spring = "closeSpring", style = "popin 60%" })
