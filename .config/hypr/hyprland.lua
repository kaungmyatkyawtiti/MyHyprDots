...
hl.on("hyprland.start", function()
	...
	-- You can add other startup apps here, for example:
	-- hl.exec_cmd("hyprpaper")
	-- hl.exec_cmd("nm-applet")
	hl.exec_cmd("wl-paste --type text --watch cliphist store")
end)

local sans_font = "Inter 11"
local mono_font = "AdwaitaMono Nerd Font 11"

hl.exec_cmd("gsettings set org.gnome.desktop.interface font-name '" .. sans_font .. "'")
...
hl.bind(mainMod .. " + SHIFT + H", hl.dsp.exec_cmd(cliphist))
...
hl.bind("CTRL + Print", hl.dsp.exec_cmd("hyprshot -m window -m active"))
...
local script_path = "~/.config/hypr/scripts/osd.sh"

hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd(script_path .. " up"), { locked = true, repeating = true })
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd(script_path .. " down"), { locked = true, repeating = true })
hl.bind("XF86AudioMute", hl.dsp.exec_cmd(script_path .. " mute"), { locked = true, repeating = true })
hl.bind("XF86AudioMicMute", hl.dsp.exec_cmd(script_path .. " micmute"), { locked = true, repeating = true })
...
hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd(script_path .. " brightup"), { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd(script_path .. " brightdown"), { locked = true, repeating = true })
